	...
	<body class="" style="overflow:auto;">
		...
		<header id="header">
			<div id="logo-group">
				<span id="logo"> 
					<a id="logoA" href="./">
					<img id="logoImg" style="width:160px;height:32px;" src="<%=basePath%>img/g7tms/logo_header.png" langlanguage="logo" alt="汇通天下G7"> </a>
				</span>
			...
			<div class="pull-right">
				...
				<div id="logout" class="btn-header transparent pull-right">
					<span> <a href="javascript:void(0);" title="退出系统" id="logoutButton"><i class="fa fa-sign-out"></i></a> </span>
				</div>
				<!-- end logout button -->
		...
		<![endif]-->
		<!-- MAIN APP JS FILE -->
		<!-- <script src="js/ips.public.js"></script> -->
		<script src="<%=basePath%>js/head.js"></script>
		<script src="<%=basePath%>themes/default/js/common_nav.js"></script>
		<script src="<%=basePath%>js/hui/jquery.hui.grid.js"></script>
