 ...
 * 
 **/
function defaults_style(style_name){
        $('body').removeClassPrefix('smart-style')
            .addClass(style_name);
    }
defaults_style("smart-style-2") //默认的风格样式ID
