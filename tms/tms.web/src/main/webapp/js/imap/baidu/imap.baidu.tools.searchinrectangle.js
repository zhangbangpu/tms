...
(function() {
    ...
    SearchInRectangle.prototype.open = function() {
        ...
        if (this._followTitle) {
            //如果设置此项,可能跟随文本被修改过,需要改回默认值
            if(this._opts.upflwtext) {
                this._followTitle.setContent(this._opts.followText);
            }
        ...
        var drawingRect = function(e) {
            if (me._isOpen == true && me._bind.isZooming == true) {
                ...
                if(me._opts.upflwtext && me._followTitle) {
                    // 计算当前矩形半透明效果框的中心点
                    ...
                    var _html = me._opts.upflwtext(bds);
                    if(_html) me._followTitle.setContent(_html);
                }
        ...
        var endDrawRect = function(e) {
            ...
            if('undefined' != typeof imap.itools) {
                // var curr = itools.getCurrTool();
                // if('newzoomin' == curr) {
                //     var viewport = map.getViewport([southWestPoint,northEastPoint]);
                //     if(viewport) {
                //         map.setCenter(viewport.center);
                //         map.setZoom(viewport.zoom);
                //     }
                // } else if('newzoomout' == curr) {
                //     var center = bds.getCenter();
                //     var centerlat = center.lat,
                //         centerlng = center.lng;
                //     var mapBound = map.getBounds();
                //     var bSw = mapBound.getSouthWest(),
                //         bNe = mapBound.getNorthEast();
                //     var c1 = bNe.lat - bSw.lat,
                //         c2 = bNe.lng - bSw.lng;
                //     var d1 = (northEastPoint.lat - southWestPoint.lat) / c1,
                //         d2 = (northEastPoint.lng - southWestPoint.lng) / c2;
                //     var d = Math.max(d1,d2);
                //     var f1 = c1 / d / 2,
                //         f2 = c2 / d / 2;
                //     var viewport = map.getViewport([
                //         new BMap.Point(centerlng - f2, centerlat - f1),
                //         new BMap.Point(centerlng + f2, centerlat + f1)
                //     ]);
                //     if(viewport) {
                //         map.setCenter(viewport.center);
                ...
                // } else 
                if('function' == typeof me._opts.callback) me._opts.callback(bds);
            }
